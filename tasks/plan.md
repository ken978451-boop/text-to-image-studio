...
- [ ] API 測試全數通過
- [ ] API Key 缺失及外部服務錯誤不洩漏內部資訊

### Phase 2: User interface

- [ ] 建立輸入、送出、載入、錯誤及圖片結果介面
- [ ] 串接 `/api/images`，避免使用 `innerHTML` 顯示外部資料
- [ ] 加入響應式及鍵盤可用性

### Checkpoint: UI

- [ ] 320、768、1024、1440px 版面可用
- [ ] 可用鍵盤完成主要流程，瀏覽器無主控台錯誤

### Phase 3: Documentation and publish

- [ ] 撰寫 README、`.env.example`、授權條款與 `.gitignore`
- [ ] 執行完整測試、依賴稽核及秘密掃描
